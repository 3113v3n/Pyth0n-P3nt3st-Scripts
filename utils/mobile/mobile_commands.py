...
from utils import Validator, Bcolors, Commands, Config

base_output_dir = "./output_directory/Mobile"


class MobileCommands(FileHandler, Validator, Bcolors, Commands, Config):
    def __init__(self):
        super().__init__()
    ...
    def inspect_application_files(self, application: str):
        ...
        print(
            ...
            f"{self.OKGREEN}{self.output_dir}{self.ENDC}"
        )
